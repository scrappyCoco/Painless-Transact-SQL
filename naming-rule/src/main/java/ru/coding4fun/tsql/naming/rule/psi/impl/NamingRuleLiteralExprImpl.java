...
public abstract class NamingRuleLiteralExprImpl extends NamingRuleExprImpl implements NamingRuleLiteralExpr {

  public NamingRuleLiteralExprImpl(@NotNull ASTNode node) {
    super(node);
  }
