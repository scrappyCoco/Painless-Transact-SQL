...
public class NamingRuleNotExprImpl extends NamingRuleExprImpl implements NamingRuleNotExpr {

  public NamingRuleNotExprImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public NamingRuleExpr getExpr() {
    return findChildByClass(NamingRuleExpr.class);
  }
