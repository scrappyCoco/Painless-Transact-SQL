...
public class NamingRuleConditionalExprImpl extends NamingRuleExprImpl implements NamingRuleConditionalExpr {

  public NamingRuleConditionalExprImpl(@NotNull ASTNode node) {
    super(node);
  }
