...
public class NamingRuleStringLiteralExprImpl extends NamingRuleExprImpl implements NamingRuleStringLiteralExpr {

  public NamingRuleStringLiteralExprImpl(@NotNull ASTNode node) {
    super(node);
  }
