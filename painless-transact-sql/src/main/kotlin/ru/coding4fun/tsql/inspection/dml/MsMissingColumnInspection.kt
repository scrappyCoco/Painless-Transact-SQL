    ...
    private class MissingColumnVisitor(
        ...
        fun visitSqlTableColumnListImpl(highlightElement: SqlElement, targetType: SqlTableType, referenceList: SqlReferenceList){
            ...
            for (columnNumber in 0 until targetType.columnCount) {
                ...
                //@formatter:off
                val isTimeStamp = "timestamp".equals(column.dataType.typeName, true)
                                       || "rowversion".equals(column.dataType.typeName, true)
                //@formatter:on
                val isRequired = column.isNotNull && !hasDefault && !DasUtil.isAutoGenerated(column) && !isTimeStamp
