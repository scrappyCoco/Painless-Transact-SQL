...
class MsPartitionFunctionNamingInspection: MsNamingInspectionBase(
    "name.convention.partition.function.default.pattern",
    "name.convention.partition.function.default.description",
    "db"
) {
    override fun createAnnotationVisitor(
        ...
        return PartitionFunctionNameVisitor(dialect, manager, problems, onTheFly)
    }

    private inner class PartitionFunctionNameVisitor(
        dialect: SqlLanguageDialectEx,
        ...
        override fun visitSqlCreateStatement(createStatement: SqlCreateStatement?) {
            ...
            if (firstLeaves[2].elementType != MsTokens.MSSQL_FUNCTION) return
