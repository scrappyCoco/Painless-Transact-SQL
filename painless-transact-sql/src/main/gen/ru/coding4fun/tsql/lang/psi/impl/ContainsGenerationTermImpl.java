...
public class ContainsGenerationTermImpl extends ASTWrapperPsiElement implements ContainsGenerationTerm {
  ...
  @Override
  @NotNull
  public PsiElement getFormsof() {
    return findNotNullChildByType(FORMSOF);
  }

  @Override
  @Nullable
  public PsiElement getInflectional() {
    return findChildByType(INFLECTIONAL);
  }

  @Override
  @Nullable
  public PsiElement getThesaurus() {
    return findChildByType(THESAURUS);
  }
